...
export default definePlugin({
    name: "StickerPull",
    description:
        "Pull and place stickers onto chat messages with a built-in overlay. Right-click stickers in the picker to Pull to Chat, drag placed stickers to reposition, right-click placed stickers to Grab or Remove.",
